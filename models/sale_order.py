            ...
            if sale.analytic_account_id and sale.order_line:
                for line in sale.order_line:
                    ...
                    if line.product_id.create_analytic_sale:
                        analytic_move_dic = {'name': line.product_id.name, 'account_id': sale.analytic_account_id.id, 'date': datetime.date.today(), 'amount': (line.product_id.standard_price * -1)* line.product_uom_qty, 'product_id': line.product_id.id }
